...
After spending one week trying to use Safari as my default browser, I decided to go back to Firefox. I was able to <a href="http://keywords.oxus.net/archives/2008/01/10/firefox-vs-safari/" onclick="_gaq.push(['_trackEvent', 'outbound-article', 'http://keywords.oxus.net/archives/2008/01/10/firefox-vs-safari/', 'find numerous substitutes']);" >find numerous substitutes</a> for my favorite Firefox plugins and features, but they never lived up to the real thing. 
